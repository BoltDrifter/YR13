...
#     vehicle.print(f"The Horizontal Position of the Vehicle is: {self.__HorizontalPosition} ")
#     vehicle.print(f"The Current Speed of the Vehicle is: {self.__CurrentSpeed} ")
#     Helicopter.print(f"The Vertical Postition of helicopter: {self.__verticalPosition}")
